  ...
  const sheetEntries = (st: ReturnType<typeof useGen.getState>) => {
    {
      ...
      const entries = [
        ...
        rk("quickslots", "Quick slots · Loadout", { slots: { q1: "5", q4: "3" } }),
        rk("quickslots", "Quick slots · Armed", { slots: { g5: "Flask", q5: "2", q1: "5", q4: "3" } }),
        rk("quickslots", "Quick slots · Custom", { slots: { g1: "Scroll", g2: "Key", g3: "Zap", g4: "Heart", q3: "2", g5: "Sword" } }),
        rk("quickslots", "Quick slots · Bare", { slots: { g1: "Empty", g2: "Empty", g3: "Empty", g4: "Empty" } }),
