...
import { Slider, FxToggle, AngleDial, FontPicker } from "./controls";
...
/* Slider, FxToggle, AngleDial and FontPicker moved to ./controls — shared
   with Type Maker. Imported above; nothing about them changed. */
