...
export type TmBackdrop = {
  /** radial card colors, center → edge */
...
const baseType = (c: GenConfig) => {
  ...
  t.fillOpacity = 100;
  t.highlight = "";
  t.outline = { on: false, color: "#0B0E14", color2: null, width: 2 };
...
export const TM_PRESETS: TmPreset[] = [
  {
    ...
    apply: (c) => {
      ...
      t.outline = { on: true, color: "#6E2A05", color2: null, width: 3.2 };
  ...
  },
  {
    ...
    apply: (c) => {
      ...
      t.outline = { on: true, color: "#5C3C05", color2: null, width: 1.6 };
      t.emboss = { on: true, strength: 40, softness: 26, distance: 2, hiOpacity: 80, shOpacity: 55, hiColor: "#FFF6D8", shColor: "#2A1602" };
      t.glints = { on: true, opacity: 45, style: "sheen", blend: "normal" };
      t.dim = { on: true, depth: 6, color: "#6B4A10", sticker: 0, stickerColor: "#FFFFFF", rim: 1.6, rimColor: "#241703", shadow: 40, gloss: 22, glossCover: 30, tilt: 0 };
  ...
  },
  {
    ...
    apply: (c) => {
      ...
      t.outline = { on: true, color: "#22303C", color2: null, width: 1.6 };
      t.emboss = { on: true, strength: 30, softness: 24, distance: 2, hiOpacity: 75, shOpacity: 55, hiColor: "#F4FAFF", shColor: "#0B1218" };
      t.glints = { on: true, opacity: 50, style: "streak", blend: "normal" };
      t.dim = { on: true, depth: 4, color: "#31414F", sticker: 0, stickerColor: "#FFFFFF", rim: 1.4, rimColor: "#101820", shadow: 35, gloss: 0, glossCover: 30, tilt: 0 };
  ...
  },
  {
    ...
    apply: (c) => {
      ...
      t.outline = { on: true, color: "#3A4552", color2: null, width: 1.6 };
      t.emboss = { on: true, strength: 35, softness: 28, distance: 2, hiOpacity: 75, shOpacity: 55, hiColor: "#FFFFFF", shColor: "#10151C" };
      t.glints = { on: true, opacity: 50, style: "stars", blend: "normal" };
      t.dim = { on: true, depth: 5, color: "#55606E", sticker: 0, stickerColor: "#FFFFFF", rim: 1.5, rimColor: "#232B36", shadow: 35, gloss: 18, glossCover: 28, tilt: 0 };
  ...
  },
  {
    ...
    apply: (c) => {
      ...
      t.outline = { on: true, color: "#FF49D8", color2: null, width: 4.2 };
