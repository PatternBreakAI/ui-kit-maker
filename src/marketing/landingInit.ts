...
<b>&lt;/svg&gt;</b>` },
  ...
  <i>"type"</i>: { <i>"weight"</i>: <em>800</em>, <i>"tracking"</i>: <em>2</em> }
      ...
      const L = {
en:{l1:"Design one",l2:"button.",l3:"Ship the whole <br>game UI.",eyebrow:"BROWSER-BASED GAME UI TOOL",lede:"Custom game-UI kits, already working in Unity.",ownTech:"Powered by a deterministic parametric design engine with true app-to-Unity parity.",
sub:'Tweak a real button right here, then push it into 115+ coordinated components: four real states, editable text and live prefabs, all in your art direction. Every pixel comes from a <em class="hl hl-w">deterministic</em> engine, <em class="hl">not AI</em>, so what you make is <em class="hl hl-w">yours</em> to ship in any game or product you sell.*',
...
sb1t:"1 MASTER COMPONENT",sb1s:"Infinite variations.",sb2t:"115+ COMPONENTS",sb2s:"Every essential.",sb3t:"4 STATES",sb3s:"Always in sync.",sb4t:"EXPORT ANYWHERE",sb4s:"Engines, web, PNG, SVG.",galL:"Straight from the app",galT:"The real thing, three screens deep.",
...
fin1t:"BROWSER-BASED",fin1s:"No installs",fin2t:"DETERMINISTIC",fin2s:"Not AI",fin3t:"GAME-READY",fin3s:"Export anywhere",fin4t:"YOURS TO SHIP",fin4s:"Sell &amp; own*",/* cross-lane touch (app session, 2026-08-17): Gate Round — the free-PNG-export claim is retired; exports are paid */ finFree:"Selected kits free to play. Exporting your designs is the Pro unlock.",
...
zh:{l1:"设计一个",l2:"按钮，",l3:"交付一整套<br>游戏 UI。",eyebrow:"浏览器端游戏 UI 工具",lede:"定制的游戏 UI 组件库，在 Unity 里开箱即用。",ownTech:"由确定性参数化设计引擎驱动：应用内与 Unity 输出完全一致。",
sub:'就在这里调一个真实按钮，然后一键推送到 115+ 个成套组件：四种真实状态、可编辑文字、直接可用的 Prefab，全部跟随你的美术方向。每个像素都来自<em class="hl hl-w">确定性</em>引擎，<em class="hl">不是 AI</em>，你做出的一切都可以用在任何你发售的游戏或产品中。*',
...
sb1t:"1 个母版组件",sb1s:"无限变化。",sb2t:"115+ 个组件",sb2s:"应有尽有。",sb3t:"4 种状态",sb3s:"永远同步。",sb4t:"随处导出",sb4s:"引擎、Web、PNG、SVG。",galL:"来自真实应用",galT:"真实产品，三个界面。",
...
fin1t:"浏览器直达",fin1s:"无需安装",fin2t:"确定性引擎",fin2s:"不是 AI",fin3t:"游戏就绪",fin3s:"随处导出",fin4t:"归你所有",fin4s:"可售可发布*",/* cross-lane touch (app session, 2026-08-17): Gate Round — the free-PNG-export claim is retired; exports are paid */ finFree:"精选组件库免费畅玩。导出你的设计需要 Pro。",
...
fr:{l1:"Créez un",l2:"bouton.",l3:"Livrez toute <br>l\u2019UI du jeu.",eyebrow:"OUTIL D’UI DE JEU DANS LE NAVIGATEUR",lede:"Des kits d\u2019UI de jeu sur mesure, déjà fonctionnels dans Unity.",ownTech:"Propulsé par un moteur de design paramétrique déterministe : parité totale entre l\u2019app et Unity.",
sub:'Réglez un vrai bouton ici, puis propagez-le en 115+ composants coordonnés : quatre vrais états, texte éditable et prefabs prêts à l\u2019emploi, le tout dans votre direction artistique. Chaque pixel vient d\u2019un moteur <em class="hl hl-w">déterministe</em>, <em class="hl">pas d\u2019IA</em> : ce que vous créez peut partir dans n\u2019importe quel jeu ou produit que vous vendez.*',
...
sb1t:"1 COMPOSANT MASTER",sb1s:"Variations infinies.",sb2t:"115+ COMPOSANTS",sb2s:"Tous les essentiels.",sb3t:"4 ÉTATS",sb3s:"Toujours synchronisés.",sb4t:"EXPORT PARTOUT",sb4s:"Moteurs, web, PNG, SVG.",galL:"Tout droit de l’app",galT:"Le vrai produit, trois écrans.",
...
fin1t:"DANS LE NAVIGATEUR",fin1s:"Zéro installation",fin2t:"DÉTERMINISTE",fin2s:"Pas d\u2019IA",fin3t:"PRÊT POUR LE JEU",fin3s:"Export partout",fin4t:"À VOUS",fin4s:"Vendez et publiez*",/* cross-lane touch (app session, 2026-08-17): Gate Round — the free-PNG-export claim is retired; exports are paid */ finFree:"Kits sélectionnés jouables gratuitement. L'export de vos designs passe par Pro.",
...
es:{l1:"Diseña un",l2:"botón.",l3:"Lanza toda la <br>UI del juego.",eyebrow:"HERRAMIENTA DE UI DE JUEGOS EN EL NAVEGADOR",lede:"Kits de UI de juego a medida, ya funcionando en Unity.",ownTech:"Impulsado por un motor de diseño paramétrico determinista: paridad total entre la app y Unity.",
sub:'Ajusta un botón real aquí mismo y propágalo a 115+ componentes coordinados: cuatro estados reales, texto editable y prefabs listos, todo con tu dirección de arte. Cada píxel sale de un motor <em class="hl hl-w">determinista</em>, <em class="hl">no de IA</em>: lo que hagas puede ir en cualquier juego o producto que vendas.*',
...
sb1t:"1 COMPONENTE MASTER",sb1s:"Variaciones infinitas.",sb2t:"115+ COMPONENTES",sb2s:"Todo lo esencial.",sb3t:"4 ESTADOS",sb3s:"Siempre en sincronía.",sb4t:"EXPORTA DONDE SEA",sb4s:"Motores, web, PNG, SVG.",galL:"Directo de la app",galT:"El producto real, tres pantallas.",
...
fin1t:"EN EL NAVEGADOR",fin1s:"Sin instalaciones",fin2t:"DETERMINISTA",fin2s:"No es IA",fin3t:"LISTO PARA JUEGOS",fin3s:"Exporta donde sea",fin4t:"TUYO PARA PUBLICAR",fin4s:"Vende y lanza*",/* cross-lane touch (app session, 2026-08-17): Gate Round — the free-PNG-export claim is retired; exports are paid */ finFree:"Kits seleccionados gratis para jugar. Exportar tus diseños es cosa de Pro.",
...
it:{l1:"Crea un",l2:"bottone.",l3:"Consegna tutta <br>la UI del gioco.",eyebrow:"STRUMENTO DI UI PER GIOCHI NEL BROWSER",lede:"Kit di UI di gioco su misura, già funzionanti in Unity.",ownTech:"Spinto da un motore di design parametrico deterministico: parità totale tra app e Unity.",
sub:'Regola un bottone vero proprio qui, poi propagalo in 115+ componenti coordinati: quattro stati reali, testo modificabile e prefab pronti all\u2019uso, tutto nella tua direzione artistica. Ogni pixel esce da un motore <em class="hl hl-w">deterministico</em>, <em class="hl">non da IA</em>: ciò che crei può finire in qualsiasi gioco o prodotto che vendi.*',
...
sb1t:"1 COMPONENTE MASTER",sb1s:"Variazioni infinite.",sb2t:"115+ COMPONENTI",sb2s:"Tutto l’essenziale.",sb3t:"4 STATI",sb3s:"Sempre in sincronia.",sb4t:"ESPORTA OVUNQUE",sb4s:"Engine, web, PNG, SVG.",galL:"Direttamente dall’app",galT:"Il prodotto vero, tre schermate.",
...
fin1t:"NEL BROWSER",fin1s:"Niente installazioni",fin2t:"DETERMINISTICO",fin2s:"Non IA",fin3t:"PRONTO PER I GIOCHI",fin3s:"Esporta ovunque",fin4t:"TUO DA PUBBLICARE",fin4s:"Vendi e lancia*",/* cross-lane touch (app session, 2026-08-17): Gate Round — the free-PNG-export claim is retired; exports are paid */ finFree:"Kit selezionati gratis da provare. Esportare i tuoi design è un'esclusiva Pro.",
...
de:{l1:"Einen Button",l2:"designen.",l3:"Das ganze <br>Game-UI liefern.",eyebrow:"GAME-UI-TOOL IM BROWSER",lede:"Maßgeschneiderte Game-UI-Kits. In Unity schon lauffähig.",ownTech:"Angetrieben von einer deterministischen parametrischen Design-Engine: mit echter Parität zwischen App und Unity.",
sub:'Stell hier einen echten Button ein und übertrag ihn auf 115+ abgestimmte Komponenten: vier echte States, editierbarer Text und fertige Prefabs, alles in deiner Art-Direction. Jeder Pixel stammt aus einer <em class="hl hl-w">deterministischen</em> Engine, <em class="hl">nicht von KI</em>: was du baust, darf in jedes Spiel und Produkt, das du verkaufst.*',
...
sb1t:"1 MASTER-KOMPONENTE",sb1s:"Unendliche Varianten.",sb2t:"115+ KOMPONENTEN",sb2s:"Alles Wesentliche.",sb3t:"4 ZUSTÄNDE",sb3s:"Immer synchron.",sb4t:"ÜBERALLHIN EXPORTIEREN",sb4s:"Engines, Web, PNG, SVG.",galL:"Direkt aus der App",galT:"Das echte Produkt, drei Screens tief.",
...
fin1t:"IM BROWSER",fin1s:"Keine Installation",fin2t:"DETERMINISTISCH",fin2s:"Keine KI",fin3t:"GAME-READY",fin3s:"Überallhin exportieren",fin4t:"DEINS ZUM SHIPPEN",fin4s:"Verkaufen &amp; veröffentlichen*",/* cross-lane touch (app session, 2026-08-17): Gate Round — the free-PNG-export claim is retired; exports are paid */ finFree:"Ausgewählte Kits gratis spielbar. Der Export eigener Designs ist Pro vorbehalten.",
...
ja:{l1:"ボタンを",l2:"ひとつ。",l3:"ゲームUIを<br>まるごと出荷。",eyebrow:"ブラウザで動くゲームUIツール",lede:"カスタムのゲームUIキットが、そのまま Unity で動く。",ownTech:"決定論的なパラメトリック・デザインエンジン搭載：アプリと Unity の出力は完全一致。",
sub:'ここで本物のボタンを調整：そのまま 115+ の統一コンポーネントへ展開。4つの実ステート、編集できるテキスト、すぐ使える Prefab まで、すべてあなたのアートディレクションで。すべてのピクセルは<em class="hl hl-w">決定論的</em>エンジンから生まれ、<em class="hl">AIではありません</em>。作ったものは、あなたが販売するどんなゲームや製品にも使えます。*',
...
sb1t:"マスターコンポーネント×1",sb1s:"無限のバリエーション。",sb2t:"115+コンポーネント",sb2s:"必須がすべて。",sb3t:"4ステート",sb3s:"常に同期。",sb4t:"どこへでも書き出し",sb4s:"エンジン・Web・PNG・SVG。",galL:"実際のアプリから",galT:"本物のプロダクト、3つの画面。",
...
fin1t:"ブラウザベース",fin1s:"インストール不要",fin2t:"決定論的",fin2s:"AIではない",fin3t:"ゲームレディ",fin3s:"どこへでも書き出し",fin4t:"あなたのもの",fin4s:"販売も公開も*",/* cross-lane touch (app session, 2026-08-17): Gate Round — the free-PNG-export claim is retired; exports are paid */ finFree:"選定キットは無料で体験。デザインの書き出しは Pro 限定。",
auT1:"おかえりなさい",auT2:"アカウントを作成",auIn:"サインイン",auUp:"アカウント作成",auEmail:"メール",auPass:"パスワード",auFgt:"パスワードをお忘れですか？",auGo1:"サインイン",auGo2:"アカウントを作成",auOr:"または",auMagic:"✉ サインインリンクを送る",auFreeL:"Free Explorer。カード不要。",auTerms:"利用規約とライセンスに同意します：どんな製品にも使えますが、素材の転売は不可。",auHi:"プレイヤー1",auOkT:"サインインしました",auOkP:"スタジオを開いています：",auDoneT:"アカウントを作成しました",auDoneP:"ようこそ。エディタを開いています：",auSentT2:"受信トレイをご確認ください",auSentP2:"サインインリンクを送信しました：",auRstT:"リセットリンクを送信しました",auRstP:"パスワード再設定の案内を送信しました：",auBackL:"戻る",bgsL:"背景"}
      ...
      const setLang = (l) => {
        ...
        const lede = q(".hero2-lede"); if (lede) lede.textContent = t("lede");
        ...
        const otc = document.getElementById("ownTech"); if (otc) otc.textContent = t("ownTech");
      ...
      try {
        const CM_KITS = [
          ...
          ["citrus-pop", "Citrus Cabinet", "@fizzworks", 97, "#65a30d"],
        ];
