    ...
    items: [
      {
        ...
        p: "The speedometer and rev meter now land in Unity as working instruments: a needle that sweeps and a numeric readout that , dressed in your kit's own digit styling, down to the glow. Drag the Value slider in the Inspector and watch it go.",
      },
      {
        h: "Every panel speaks your words",
        p: "Leaderboards, lap-time charts, telemetry readouts, loot tags, list rows and their kin used to arrive as silent artwork. : the exact text you typed on your boards, live and editable in Unity, seated and styled to match the app. Rows come as duplicable objects, so a five-row leaderboard becomes a six-row one with a copy.",
      },
      {
        h: "A prefab for every word you pinned",
        p: "Buttons, chips and tabs arrive already saying , and every different word you pinned on a board becomes its own drag-ready Prefab Variant that keeps its word while inheriting every future restyle of its base automatically.",
      },
      {
      ...
      },
      {
        ...
        p: "The kit's font is now fetched from several independent sources at export time. In the rare case it still can't be bundled, the site tells you before you download , and the next successful export re-dresses everything already in your Unity project, in place.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        p: "Idle motion joins the kit: a wipe shine that sweeps each face and rests, and an edge shine that runs a spark around the silhouette. Turn them on kit-wide or per piece, tune the rhythm and blend, and both ride into Unity as removable components. Type stamps mask the sweep : light moves through the words, never over their box.",
      },
      {
        h: "The segmented selector reads on any background",
        p: "Its off cells : how present the quiet options are, from a whisper to full strength, and whether they keep the kit's full type styling , so the unselected words stay readable on loud backdrops without touching the selected cell.",
      },
      {
      ...
      },
      {
        ...
        p: "The slicing bench's stretch diagram now measures its guides from your actual silhouette . An off-center design shows off-center guides, because that's what your button really does. And the export's guide explains when to reach for a ready scene piece versus a prefab.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      {
        ...
        p: "Select any piece on the Board and scale it from any of the four corners, or from the top-center and bottom-center handlebars. Whichever handle you grab, . The piece grows toward your pointer, and one undo takes back the whole gesture.",
      },
      {
        h: "Selection boxes that tell the truth",
        p: "Boxes now , including warped type stamps, where the box wraps the actual lettering instead of the empty air around it. What you see selected is what you're moving.",
      },
      {
      ...
      },
      {
        ...
        p: "Sliders, progress bars, segmented meters and the VS health bar grow new side handles: pull an edge and : caps, knob and inset stay true instead of distorting, exactly like a nine-slice in an engine. Corners still scale the whole piece proportionally.",
      },
      {
      ...
      },
      {
        ...
        p: "The vignette's inverse: subtly darken : the move games make behind menus so the UI pops. It stacks with the vignette and the overlay washes, or works alone, and it exports with the board.",
      },
      {
      ...
      },
      {
        ...
        p: "A board's Clear button now : pieces and background together, and it tells you exactly what's going before it goes. And the empty-stage hint no longer prints itself over a backdrop you just uploaded; it waits for a truly bare board.",
      },
      {
        h: "Backdrops choose how they meet the frame",
        p: "A new Fill / Fit switch in the darkroom for image backgrounds. Fill covers the board edge to edge, cropping the overflow: today's look. Fit shows the whole scene, nothing cropped, floating over a softly : the cure for art whose aspect isn't the board's, like a portrait scene on a modern phone stage. Exports render whichever you chose, exactly as the stage shows it.",
      },
      {
    ...
    lab: [
      ...
      },
      {
        ...
        p: "A settings gear, a trophy, : each one the illustrated object itself wearing your kit's full material treatment, no box around it.",
      },
    ],
  },
];
