...
export const SILHOUETTES: SilhouetteMeta[] = [
  ...
  { id: "stock:bubbleslab", preview: true, flippable: true, name: "Bubble Slab", category: "Blobs", source: "custom (PatternBreak blob set)", license: "original", renderer: "path",
  ...
  { id: "stock:teardroplozenge", preview: true, flippable: true, name: "Teardrop Lozenge", category: "Blobs", source: "custom (PatternBreak blob set)", license: "original", renderer: "path",
  ...
  { id: "stock:swellbar", preview: true, flippable: true, name: "Swell Bar", category: "Blobs", source: "custom (PatternBreak blob set)", license: "original", renderer: "path",
  ...
  { id: "stock:wavecapsule", preview: true, flippable: true, name: "Wave Capsule", category: "Blobs", source: "custom (PatternBreak blob set)", license: "original", renderer: "path",
  ...
  { id: "stock:cobblebar", preview: true, flippable: true, name: "Cobble Bar", category: "Blobs", source: "custom (PatternBreak blob set)", license: "original", renderer: "path",
  ...
  { id: "stock:wedgeblob", preview: true, flippable: true, name: "Wedge Blob", category: "Blobs", source: "custom (PatternBreak blob set)", license: "original", renderer: "path",
  ...
  { id: "stock:cushionslab", preview: true, flippable: true, name: "Cushion Slab", category: "Blobs", source: "custom (PatternBreak blob set)", license: "original", renderer: "path",
  ...
  { id: "stock:scallopblock", preview: true, flippable: true, name: "Scallop Block", category: "Blobs", source: "custom (PatternBreak blob set)", license: "original", renderer: "path",
  ...
  { id: "stock:longloaf", preview: true, flippable: true, name: "Long Loaf", category: "Blobs", source: "custom (PatternBreak blob set)", license: "original", renderer: "path",
  ...
  { id: "stock:rollingbar", preview: true, flippable: true, name: "Rolling Bar", category: "Blobs", source: "custom (PatternBreak blob set)", license: "original", renderer: "path",
  ...
  { id: "stock:peanutpill", preview: true, flippable: true, name: "Peanut Pill", category: "Blobs", source: "custom (PatternBreak blob set)", license: "original", renderer: "path",
