...
export const SILHOUETTES: SilhouetteMeta[] = [
  ...
  { id: "stock:bubbleslab", name: "Bubble Slab", category: "Blobs", source: "custom (PatternBreak blob set)", license: "original", renderer: "path", preview: true,
  ...
  { id: "stock:teardroplozenge", name: "Teardrop Lozenge", category: "Blobs", source: "custom (PatternBreak blob set)", license: "original", renderer: "path", preview: true,
  ...
  { id: "stock:swellbar", name: "Swell Bar", category: "Blobs", source: "custom (PatternBreak blob set)", license: "original", renderer: "path", preview: true,
  ...
  { id: "stock:wavecapsule", name: "Wave Capsule", category: "Blobs", source: "custom (PatternBreak blob set)", license: "original", renderer: "path", preview: true,
  ...
  { id: "stock:cobblebar", name: "Cobble Bar", category: "Blobs", source: "custom (PatternBreak blob set)", license: "original", renderer: "path", preview: true,
  ...
  { id: "stock:wedgeblob", name: "Wedge Blob", category: "Blobs", source: "custom (PatternBreak blob set)", license: "original", renderer: "path", preview: true,
  ...
  { id: "stock:cushionslab", name: "Cushion Slab", category: "Blobs", source: "custom (PatternBreak blob set)", license: "original", renderer: "path", preview: true,
  ...
  { id: "stock:scallopblock", name: "Scallop Block", category: "Blobs", source: "custom (PatternBreak blob set)", license: "original", renderer: "path", preview: true,
  ...
  { id: "stock:longloaf", name: "Long Loaf", category: "Blobs", source: "custom (PatternBreak blob set)", license: "original", renderer: "path", preview: true,
  ...
  { id: "stock:rollingbar", name: "Rolling Bar", category: "Blobs", source: "custom (PatternBreak blob set)", license: "original", renderer: "path", preview: true,
  ...
  { id: "stock:peanutpill", name: "Peanut Pill", category: "Blobs", source: "custom (PatternBreak blob set)", license: "original", renderer: "path", preview: true,
