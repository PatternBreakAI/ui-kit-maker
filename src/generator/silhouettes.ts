...
export const SILHOUETTES: SilhouetteMeta[] = [
  ...
  /* ── Vigilante — the night-hero drop (owner upload, 2026-08-06),
     UNLISTED PREVIEW (admins only) for testing. Three families in
     rack order: winged emblems, comic title plaques, velocity bars.
     Caps and content boxes measured from each outline as always;
     all on the kernel cut. ── */
  { id: "stock:eclipsesigil", name: "Eclipse Sigil", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:ravendart", name: "Raven Dart", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:starwarden", name: "Star Warden", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:stormburst", name: "Storm Burst", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:taloncrest", name: "Talon Crest", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:hornguard", name: "Horn Guard", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:phantombanner", name: "Phantom Banner", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:swiftwing", name: "Swift Wing", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:shadowcowl", name: "Shadow Cowl", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:capeshield", name: "Cape Shield", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:crestedward", name: "Crested Ward", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:splashcrown", name: "Splash Crown", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:boldmasthead", name: "Bold Masthead", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:captionpeak", name: "Caption Peak", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:inkerpanel", name: "Inker Panel", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:kitecard", name: "Kite Card", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:halftoneslab", name: "Halftone Slab", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:gutterslab", name: "Gutter Slab", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:panelprime", name: "Panel Prime", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:ridgecaption", name: "Ridge Caption", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:crestpanel", name: "Crest Panel", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:bracketsplash", name: "Bracket Splash", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:framesplash", name: "Frame Splash", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:velocityhex", name: "Velocity Hex", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:turbonotch", flippable: true, name: "Turbo Notch", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:slipstreambar", flippable: true, name: "Slipstream Bar", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:dashplate", name: "Dash Plate", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:vectorwedge", name: "Vector Wedge", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:rushslab", flippable: true, name: "Rush Slab", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:boostbar", flippable: true, name: "Boost Bar", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:skewstreak", flippable: true, name: "Skew Streak", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:driftplate", name: "Drift Plate", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:strikebar", name: "Strike Bar", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:chargewedge", flippable: true, name: "Charge Wedge", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
  ...
  { id: "stock:leanrunner", flippable: true, name: "Lean Runner", category: "Vigilante", source: "custom (PatternBreak vigilante set)", license: "original", renderer: "path", preview: true, gothicCut: true,
